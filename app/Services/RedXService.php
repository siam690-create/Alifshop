...
class RedXService
{
    ...
    {
        $resolveStatusId = function (array $aliases, ?int $fallback = null) {
        ...
        $statusMap = [
            'ready-for-delivery' => $inCourierStatusId,
            'delivery-in-progress' => $inCourierStatusId,
            'delivered' => $deliveredStatusId,
            'partial-delivered' => $partialDeliveredStatusId,
            'partial-delivery' => $partialDeliveredStatusId,
