    ...
    public function index(Request $request)
    {
        ...
        $query = Order::whereNotNull('reseller_profit')
            ...
            ->with([
                ...
                'orderdetails.image',
                'user:id,name,email,shop_name' // Reseller user
            ])
            ->latest();
        ...
        if ($request->filled('product_id')) {
            ...
            $query->whereHas('orderdetails', function ($orderDetailsQuery) use ($productId) {
        ...
        })->select('id', 'name', 'email', 'shop_name')->get();

        $productIds = OrderDetails::whereNotNull('product_id')
            ->whereHas('order', function ($orderQuery) {
                $orderQuery->whereNotNull('reseller_profit')
        ...
        return view('backEnd.reseller_orders.index', compact('orders', 'orderStatuses', 'resellers', 'products'));
    }
