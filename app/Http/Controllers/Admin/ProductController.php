...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'custom_product_code' => 'nullable|string|max:100|unique:products,product_code',
        ...
        $input['product_code']    = $request->filled('custom_product_code')
            ? trim((string) $request->custom_product_code)
            : 'P' . str_pad($last_id, 4, '0', STR_PAD_LEFT);
    ...
    public function update(Request $request)
    {
        $this->validate($request, [
            'name'           => 'required',
            'category_id'    => 'required',
            'custom_product_code' => 'nullable|string|max:100|unique:products,product_code,' . $request->id,
            'new_price'      => 'nullable|numeric|min:0',
            'purchase_price' => 'nullable|numeric|min:0',
            'stock'          => 'nullable|integer|min:0',
            'description'    => 'required',
    ...
    {
        $request->validate([
            'hidden_id' => 'required|exists:products,id',
        ]);
    ...
    public function imgdestroy(Request $request)
    {
        ...
        $possiblePublicPath = str_replace('storage/', '', $img->image); // if DB stores 'storage/uploads/...'
