...
class SettingsController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($customer) {
            ...
            if (empty($customer->slug)) {
                $customer->slug = $this->generateCustomerSlug($request->name, $customer->id);
            }
            $customer->save();
        } else {
            ...
            Customer::create([
                'name' => $request->name,
                'slug' => $this->generateCustomerSlug($request->name),
                'email' => $request->email,
                'phone' => $request->phone,
    ...
    private function generateCustomerSlug(string $name, ?int $ignoreId = null): string
    {
        ...
        while (
            Customer::when($ignoreId, function ($query) use ($ignoreId) {
