                ...
                <div class="order-body">
                    @php
                        ...
                        if ($trackingId) {
                            if ($courierType === 'pathao') {
                                ...
                                $trackingUrl = 'https://go.paperfly.com.bd/track/order/' . $trackingId;
                            }
                        }
                    @endphp
                    ...
                    <div class="tracking-box">
                        <div class="tracking-content">
                            <div class="tracking-label">Courier Tracking</div>
                            @if($trackingId)
                                <div class="tracking-id">ID: {{ $trackingId }}</div>
                            @else
                                <div class="tracking-empty">Courier e send hole tracking link ekhane show korbe.</div>
                            @endif
                        </div>
                        @if($trackingId && $trackingUrl)
                            <div class="tracking-action">
                                <a href="{{ $trackingUrl }}" target="_blank" rel="noopener noreferrer" class="tracking-btn">
                    ...
                    <div class="row g-4 align-items-center">
                        @php
                            $displayCustomerName = $order->shipping->name ?? $order->customer->name ?? 'Guest Customer';
                            $displayCustomerPhone = $order->shipping->phone ?? $order->customer->phone ?? 'N/A';
                        @endphp
                        
                        <div class="col-md-5 border-end-md">
                            <div class="customer-info">
                                <div class="customer-avatar">
                                    {{ substr($displayCustomerName, 0, 1) }}
                                </div>
                                <div>
                                    <h6 class="fw-bold text-dark mb-1">{{ $displayCustomerName }}</h6>
                                    <p class="text-muted mb-1 small"><i class="fas fa-phone-alt me-1 text-secondary"></i> {{ $displayCustomerPhone }}</p>
