                ...
                <div class="p-4 flex-grow-1 d-flex flex-column">
                    ...
                    <div class="mt-auto pt-3 border-top border-light">
                        ...
                        <div class="d-flex gap-2 position-relative" style="z-index: 2;">
                            ...
                            <a href="{{ route('reseller.products.quick_order', $product->slug) }}" class="btn btn-primary btn-sm rounded-pill w-100 d-flex align-items-center justify-content-center fw-bold shadow-sm" style="background: var(--primary-gradient); border:none; text-decoration: none;">
                                <i class="fas fa-bolt me-2"></i> কুইক অর্ডার
                            </a>
                        </div>
                    </div>
                </div>
