        ...
        <div class="col-lg-8">
            ...
            <div class="product-detail-card mb-4">
                <div class="d-flex justify-content-end mb-3">
                    <button type="button" class="section-action-btn" onclick="downloadCurrentImage()" title="Image Download">
            ...
            <div class="product-detail-card">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                    ...
                    <button type="button" class="section-action-btn" onclick="copyDescriptionContent()" title="Full Description Copy">
                ...
                <div class="mb-4">
                    ...
                    <div class="text-muted" id="productDescriptionContent">
        ...
        <div class="col-lg-4">
            ...
            <div class="product-detail-card mb-4">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('reseller.products.quick_order', $product->slug) }}" class="btn btn-success btn-lg rounded-pill w-100">
                        <i class="fas fa-bolt me-2"></i> কুইক অর্ডার করুন
                    </a>
...
<script>
    ...
    function downloadCurrentImage() {
        ...
        link.href = image.src;
        link.download = '{{ \Illuminate\Support\Str::slug($product->name) ?: "product-image" }}.jpg';
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
        showActionToast('Product image download started.');
    }

    function copyDescriptionContent() {
        const descriptionNode = document.getElementById('productDescriptionContent');
        if (!descriptionNode) {
            return;
        }

        const text = descriptionNode.innerText.trim();
        navigator.clipboard.writeText(text).then(function() {
            showActionToast('Full product description copied.');
        });
    }
