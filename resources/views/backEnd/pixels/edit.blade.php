                    ...
                    <form action="{{route('pixels.update')}}" method="POST" data-parsley-validate>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <small class="text-muted d-block mt-2">
                                <i class="fe-info"></i> Meta Events Manager থেকে পাওয়া Pixel ID.
                            </small>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('access_token') is-invalid @enderror"
                                      ...
                                      placeholder="Paste Meta Conversions API access token">{{ old('access_token', $edit_data->access_token ?? '') }}</textarea>
                            <small class="text-muted d-block mt-2">
                        ...
                        <div class="form-group mb-4">
                            <div class="d-flex justify-content-between align-items-center border p-3 rounded bg-light">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="browser_tracking_enabled" value="1" @if(($edit_data->browser_tracking_enabled ?? 1) == 1) checked @endif>
                        ...
                        <div class="form-group mb-4">
                            <div class="d-flex justify-content-between align-items-center border p-3 rounded bg-light">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="server_tracking_enabled" value="1" @if(($edit_data->server_tracking_enabled ?? 0) == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
