                    ...
                    @foreach ($menucategories as $value)
                        <div class="cat_item">
                            ...
                            <div class="cat_name">
                                ...
                                <div class="cat_count">
                                    ({{ $value->approved_products_count ?? 0 }})
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="product_slider owl-carousel">
                    @foreach ($hotdeal_top as $key => $value)
                        <div class="product_item wist_item wow zoomIn"
                            ...
                            @endphp
                            <div class="shop-rating-stars homepage-product-rating">
...
.homepage-product-rating i,
.homepage-product-rating .far.fa-star,
.homepage-product-rating .fas.fa-star-half-alt {
    color: #ff2d2d;
}
