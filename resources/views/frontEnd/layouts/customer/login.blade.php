                ...
                <div class="mt-4 pt-3 border-top">
                    <div class="mb-2">
                        ...
                        <div class="d-flex gap-2 align-items-center flex-wrap mb-2">
                            <input type="text" class="form-control form-control-sm bg-light" value="01616355160" readonly style="flex:1;min-width:0;border:1px solid #ddd;">
                            ...
                            <button type="button" class="btn btn-sm demo-use-btn" onclick="fillDemoCreds('01616355160','12345678')">Use</button>
                        </div>
                    </div>
                    <div>
                        <small class="d-block mb-1 text-muted">ভেন্ড্রর ইউজার</small>
                        <div class="d-flex gap-2 align-items-center flex-wrap">
                            <input type="text" class="form-control form-control-sm bg-light" value="01961394010" readonly style="flex:1;min-width:0;border:1px solid #ddd;">
                            ...
                            <button type="button" class="btn btn-sm demo-use-btn" onclick="fillDemoCreds('01961394010','12345678')">Use</button>
                        </div>
                    </div>
                </div>
                @endif
